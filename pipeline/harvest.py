"""TEMPORARY probe (stands in for harvest.py during the transport bake-off).
Exits non-zero so curate/rewrite/assemble never run and nothing is committed."""
import re
import subprocess
import sys
import urllib.parse
...
print("=== RSC image transport bake-off ===", flush=True)
...
raise SystemExit(1)   # halt the pipeline; commit nothing
